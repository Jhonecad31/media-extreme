          ...
          return (
            <div
              ...
              style={{
                ...
                boxShadow: isOpen
                  ? `0 0 0 1px ${accentColor}40, 0 1px 2px 0 rgba(0, 0, 0, 0.05)`
                  : undefined,
              }}
            >
              {/* Question Header */}
                ...
                >
                  {(() => {
                    const isImg =
                      ...
                      (item.img.startsWith("/") || item.img.endsWith(".webp"));
                    return !isImg && item.img ? (
                      <i
                        className={`bx ${item.img} text-lg`}
