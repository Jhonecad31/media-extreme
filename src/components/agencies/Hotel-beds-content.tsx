...
export default function HotelBedsContent({ lang, dict }: AgencyContentProps) {
  ...
  const tacoGallery = [
    { src: 'gallery-media-extreme/faro_puerto_morelos.webp', alt: 'Beach Taco Tour 02' },
    { src: 'gallery-media-extreme/food_hot_taco.webp', alt: 'Beach Taco Tour 01' },
    { src: 'gallery-media-extreme/iglesia_puerto_morelos.webp', alt: 'Beach Taco Tour 11' },
    { src: 'gallery-media-extreme/market_taco.webp', alt: 'Beach Taco Tour 15' },
    { src: 'gallery-media-extreme/playa_y_tacos.webp', alt: 'Beach Taco Tour 12' },
    { src: 'gallery-media-extreme/taco_taco.webp', alt: 'Beach Taco Tour 09' },
    { src: 'gallery-media-extreme/tequila_testing.webp', alt: 'Beach Taco Tour 13' }
  ];
    ...
    <div className="bg-[#f8fafc] min-h-screen pt-8 pb-16 text-[#1c2a4b] font-sans selection:bg-[#e2001a]/30">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="mt-8 border-t border-slate-200/60 pt-12">
          <h3 className="text-3xl font-black text-[#010102] mb-8">
